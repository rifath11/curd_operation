...
<?php
    include 'dbconn.php';
    $id = $_GET['id'];
    $update = "SELECT * FROM info WHERE id = $id";
    ...
    $insertquery =  "UPDATE info SET first_name ='$first_name', last_name ='$last_name', email ='$email',gender='$gender' WHERE id = $id";
		...
		<div class="modal-content">
			<form method="POST" action="">
				...
				<div class="modal-body">					
					...
					<div class="form-group">
						<label>Gender</label>
						<input type="option" name="gender" class="form-control" value="<?php echo $result['gender']; ?>" required>
					</div>					
				</div>
